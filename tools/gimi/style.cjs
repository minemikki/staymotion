...
@media (max-width:720px){
  ...
  .hero__img img{object-position:58% 50%;filter:brightness(.92) saturate(1.02);
    animation:heroLiveM 22s ease-in-out infinite alternate;transform-origin:50% 74%}
  @keyframes heroLiveM{0%{transform:scale(1.14)}100%{transform:scale(1.2)}}
  .hero__in{padding-block:0 1.8rem;margin-bottom:3.4rem}
