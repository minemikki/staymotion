...
export const PACKAGES = {
  ...
  sprint:    { id: 'sprint',    name: 'StayMotion Komplett nettside',  fromKr: 16000, depositPct: 50,  deliver: 'ca. 5 virkedager etter innhold' },
  landing:   { id: 'landing',   name: 'StayMotion Landingsside',       fromKr: 7900,  depositPct: 100, deliver: 'ca. 3 virkedager' },
  // Established package ladder (kept — larger projects are quoted individually).
  launch:    { id: 'launch',    name: 'StayMotion Oppstart',    fromKr: 7900,  depositPct: 50, deliver: 'ca. 7–14 dager' },
  growth:    { id: 'growth',    name: 'StayMotion Vekst',       fromKr: 12900, depositPct: 50, deliver: 'ca. 2–3 uker' },
  signature: { id: 'signature', name: 'StayMotion Signatur',    fromKr: 19900, depositPct: 40, deliver: 'ca. 3–5 uker' },
  care:      { id: 'care',      name: 'StayMotion Vedlikehold', fromKr: 1490,  depositPct: 100, deliver: 'løpende', monthly: true },
};
