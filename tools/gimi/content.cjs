...
const t = {
  no: {
    ...
    selskapStat1N: '30',
    selskapStat1B: 'rundt samme bord — hele huset, ikke bare et rom i det',
    selskapStat2N: '1',
    selskapStat2B: 'meny satt sammen for akkurat dere',
    selskapStat3N: 'Hele',
    selskapStat3B: 'baren, for kvelden dere har den',
  ...
  en: {
    ...
    selskapStat1N: '30',
    selskapStat1B: 'around one table — the whole house, not just a room in it',
    selskapStat2N: '1',
    selskapStat2B: 'menu, built for exactly you',
    selskapStat3N: 'The whole',
    selskapStat3B: 'bar, for the night you have it',
