...
export function renderEmail({ heading, html, ctaText, ctaUrl, preheader, badge, kicker, refLabel, refValue }) {
  ...
  const button = ctaText && ctaUrl
    ...
    : '';
  return `<div style="margin:0;padding:0;background:#EFEBE4;background-color:#EFEBE4">
    ${preheader ? `<div style="display:none;max-height:0;overflow:hidden;opacity:0">${preheader}</div>` : ''}
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#EFEBE4;background-color:#EFEBE4">
