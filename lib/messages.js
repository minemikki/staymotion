...
const TYPES = {
  ...
  proposal: {
    ...
    build(ctx) {
      ...
      const OFFERS = { landing: 'Første trekk (landingsside)', sprint: 'Momentum (komplett nettside)', signature: 'Signatur (skreddersydd nettopplevelse)', care: 'Videre (drift og oppfølging)' };
