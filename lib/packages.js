...
// Package ids from the old video business (cinematic reels from customer
// photos). They are NOT in PACKAGES — the catalogue above is webdesign only —
// but old orders in the blob store still carry them, and those orders keep
// working for the customers who bought them. They just have no business
// showing up in the webdesign sales panel or on the delivery board.
//
