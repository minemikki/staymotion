...
module.exports = `
:root{
  /* Monokrom varm off-white. Fargen kommer fra maten, ikke fra flatene. */
  --ground:#FAF8F4;--raised:#F2EFE9;--raised2:#EAE6DE;
  --ember:#16140F;--ember-l:#7C766C;--ember-d:#000000;
  --fire:#F2EFE9;--on-fire:#16140F;
  --bone:#16140F;--ash:#78736B;--ash-d:#9A948A;
  --line:#E4DFD5;--line-l:#D2CBBE;
...
/* ---------- ordmerke ---------- */
.mark{font-family:var(--sans);font-weight:600;font-size:.98rem;letter-spacing:.52em;text-transform:lowercase;color:#FBF6EE;padding-left:.52em}
...
.top nav a{font-size:.76rem;font-weight:500;letter-spacing:.16em;text-transform:uppercase;color:#FBF6EE;opacity:.88;transition:opacity .2s}
.top nav a:hover{opacity:1}
.top-r{display:flex;align-items:center;gap:1.4rem}
.lang{display:flex;box-shadow:inset 0 0 0 1px rgba(251,246,238,.48)}
.lang button{min-width:40px;min-height:32px;font-size:.66rem;font-weight:600;letter-spacing:.12em;text-transform:uppercase;color:#FBF6EE;opacity:.78;transition:.2s}
.lang button[aria-pressed=true]{background:#FBF6EE;color:#2A1C12;opacity:1}
.lang button:hover{opacity:1}
.burger{display:none;position:relative;width:44px;height:44px}
.burger span{position:absolute;left:11px;width:22px;height:1.5px;background:#FBF6EE;transition:transform .25s ease,opacity .25s ease}
...
.hero::after{content:"";position:absolute;inset:0;z-index:-1;pointer-events:none;
  background:linear-gradient(180deg,rgba(18,16,12,.44) 0%,rgba(18,16,12,.06) 26%,rgba(18,16,12,.30) 68%,rgba(18,16,12,.56) 100%),
             linear-gradient(98deg,rgba(16,14,11,.62) 0%,rgba(16,14,11,.22) 44%,transparent 68%)}
...
.hero .btn,.top .btn{background:#FBF8F3;color:#16140F}
.hero .btn:hover,.top .btn:hover{background:#FFFFFF}
`;
